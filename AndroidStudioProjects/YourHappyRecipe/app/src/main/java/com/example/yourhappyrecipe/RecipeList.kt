...
class RecipeList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ingredientsCheck!! != "" && searchCheck!! != "") {
            ...
            val tempUrl = Companion.LEFT_LINK + ingredientsCheck.toString() + Companion.QUERY + searchCheck.toString()
            url = tempUrl
            Log.d("TEMP URL ===>", url)
        } else {
...
//                            Instantiating RecipeListAdapter
    ...
    companion object {
        private const val LEFT_LINK: String = "http://www.recipepuppy.com/api/?i="
